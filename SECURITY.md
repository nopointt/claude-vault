...
If you discover a security vulnerability in contexter-vault, please report it responsibly:

1. **Do NOT open a public GitHub issue** for security vulnerabilities.
2. Email: danchoachona@gmail.com with subject "contexter-vault security".
3. Include: description, reproduction steps, impact assessment.
4. Expected response time: 48 hours.

## Security Model

### What contexter-vault protects
...
### What contexter-vault does NOT protect
